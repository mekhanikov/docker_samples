...
docker run -d -p 3376:3376 -t -v /home/vagrant/.certs:/certs:ro swarm manage -H 0.0.0.0:3376 --tlsverify --tlscacert=/certs/ca.pem --tlscert=/certs/manager-cert.pem --tlskey=/certs/manager-priv-key.pem token://${new_filename}
